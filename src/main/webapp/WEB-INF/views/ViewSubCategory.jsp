...
<title>Expanse Manager | View SubCategory </title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table" border="1" >
				...
				<tr>
					<td><%=subCategoryBean.getSubcategoryId()%></td>
					<td><%=subCategoryBean.getCategoryId()%></td>
					<td><%=subCategoryBean.getCategoryName() %></td>
					<td><%=subCategoryBean.getSubcategoryName()%></td>
					<td><%=subCategoryBean.getDeleted()%></td>
              ...
              <div class="row mb-4">
                  ...
                  <a type="button" href="../sublistcategories" class="btn btn-primary" >Back</a>
