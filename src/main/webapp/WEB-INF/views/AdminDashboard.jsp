          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-3">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">TansactionCount<span>| Today</span></h5>
            ...
            <div class="col-12">
              <div class="card"> 
                 ...
                 <div class="card-body"> 
                  <h5 class="card-title">Expense-Monthly<span>/Today</span></h5>
...
<div class="card">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      © Copyright <strong><span>ExpenseManager</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
