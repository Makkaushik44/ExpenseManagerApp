              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter Your Update Password Details</p>
                  </div>

                  <form class="row g-3 needs-validation" action="updatemypassword" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" required>
                      <div class="invalid-feedback">Please enter your cofirm password!</div>
                    </div>
                    
                     <div class="col-12">
                      <label for="yourName" class="form-label">OTP</label>
                      <input type="text" name="otp" class="form-control" id="yourName" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" value="Update Password">Submit</button>
                    </div>
